...
\begin{lstlisting}
https://github.com/v-samyuktha/AI1103/blob/Assignment-5/master/Assignment-5.py
\end{lstlisting}
%
and latex-tikz code from 
%
\begin{lstlisting}
https://github.com/v-samyuktha/AI1103/blob/Assignment-5/master/Assignment-5.tex
\end{lstlisting}
...
k&\leq4
\end{align}
From equations \brak{2.0.6} and \brak{2.0.10} we see that $\pr{X = k}$ is maximized for k=3, k=4\\
